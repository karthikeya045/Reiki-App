  ...
  te: {
    translation: {
      ...
      karunaSecondLevelSymbols: [
        {
          name: 'గ్నోసా',
          description: 'గ్నోసా - అభ్యాసం, ఆవిష్కరణ మరియు సమైకం కోసం సహాయపడుతుంది; అధ్యయనం, పరీక్షలు మరియు జ్ఞానాన్ని ఆత్మీయతతో కలిపే పనులకు మద్దతు.',
          bullets: [
            'స్మృతి, ఫోకస్ మరియు సమైక్యానికి మద్దతు',
        ...
        {
          name: 'క్రియా',
          description: 'క్రియా - లోతైన శరీర శుద్ధి మరియు డిటాక్స్; రికవరీని వేగవంతం చేస్తుంది, అవయవ శుద్ధి మరియు శక్తి ప్రవాహాన్ని మెరుగుపరుస్తుంది.',
          bullets: [
